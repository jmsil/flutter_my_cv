...
class AppTheme {
  ...
  static final Color highLightColor = Colors.blueGrey[100]!;
  ...
  static final Color midBlue = Colors.blue[500]!;
  static final Color darkBlue = Colors.blue[900]!;
  static final Color lowDarkColor = Colors.blueGrey[700]!;
  static final Color midDarkColor = Colors.blueGrey[800]!;
  static final Color highDarkColor = Colors.blueGrey[900]!;
  ...
  static final TextStyle largeDarkBlueBoldStyle =
    TextStyle(fontSize: _largeFontSize, color: darkBlue, fontWeight: FontWeight.bold);
