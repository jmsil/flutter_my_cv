class AppStrings {
  ...
  static String get details => _select(
    'Detalhes',
    'Details'
  );

  static String get brazil => _select(
    'Brasil, GO',
    'Brazil, GO'
  );

  static String get skills => _select(
    'Habilidades',
    'Skills'
  );

  static String get aboutAndExpectationsTitle => _select(
    'Sobre Mim/Expectativas',
    'About Me/Expectations'
  );

  static String get aboutAndExpectationsText => _select(
  ...
  static String get powredByFlutter => _select(
    'Feito com Flutter',
    'Powered by Flutter'
  );
  ...
  static String get professionalSummaryText => _select(
  ...
  static String get mobileGameExperienceTitle => _select(
    ...
    'Design/Development of Casual Games'
  );

  static String get mobileGameExperienceText => _select(
  ...
  static String get santriExperienceTitle => _select(
    ...
    'ERP Application Development - Santri Systems'
  );

  static String get santriExperiencePeriod => _select(
    'Outubro de 2007 - Abril de 2012',
    'October 2007 - April 2012'
  );

  static String get santriExperienceText => _select(
  ...
  static String get smallERPText => _select(
  ...
  static String get educationUniversityTitle => _select(
    'Redes de Computadores - Faculdade Estácio de Sá',
    'Computer Networks - Estácio de Sá University'
  );

  static String get educationUniversityText => _select(
  ...
  static int langIdx = 1;

  static bool setLanguage(int idx) {
    if (idx == langIdx)
      return false;
    langIdx = idx;
    return true;
